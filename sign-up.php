...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark navbar-custom fixed-top">
        <div class="container">
            ...
            <!-- <a class="navbar-brand logo-text page-scroll" href="index">Tivo</a> -->
    ...
    <header id="header" class="ex-2-header">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1>CADASTRAR</h1>
                   <p>Preencha o formulário abaixo para se inscrever na Ecoos. Já se-inscreveu? <a class="white" href="log-in">Entrar</a></p> 
                    <!-- Sign Up Form -->
                    <div class="form-container">
                        <form data-toggle="validator" method="POST" action="php/log.php">
                            <div class="form-group">
                                <input type="email" class="form-control-input" id="semail" name="email" required autocomplete="off">
                                <label class="label-control" for="semail">Email</label>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control-input" id="sname" name="nome" required autocomplete="off">
                                <label class="label-control" for="sname">Nome</label>
                                <div class="help-block with-errors"></div>
                            </div>
                            <div class="form-group">
                                <input type="password" class="form-control-input" id="spassword" name="senha" required>
                            ...
                            <div class="form-group">
                                <input type="submit" class="form-control-submit-button" name="submit"></input>
                            </div>
                            <?php
                            $resultado = filter_input(INPUT_GET, 'resultado');
                            echo "<p style='color: red; font-weight:500;  font-size: 12pt; font-family: Kdam Thmor Pro, sans-serif;'>  $resultado</p>";
                            ?>
